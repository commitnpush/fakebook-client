...
function Logo(){
    return (
        <div className="Logo">
            <FontAwesomeIcon icon={['fab', 'facebook-square']} className="Logo__svg"/>
        </div>
    );
}
...
function SideNav(){
    return (
        <div className="SideNav">
            ...
            <div className="left-pipe"></div>
            <NavIcon>
                <FontAwesomeIcon className="NavIcon__svg" icon="users" title="친구요청"/>
            </NavIcon>
            <NavIcon>
                <FontAwesomeIcon className="NavIcon__svg" icon={['fab', 'facebook-messenger']} title="메시지"/>
            </NavIcon>
            <NavIcon>
            ...
            <div className="left-pipe"></div>
            <NavIcon>
                <FontAwesomeIcon className="NavIcon__svg" icon="question-circle" title="빠른도움말"/>
            </NavIcon>
            <NavIcon>
...
function NavText({text}){
    return(
        <span className="NavItem__NavText">{text}</span>
    )
}
