  ...
  render() {
    return (
      <div className="Articles">
        <ArticleInput getArticles={this.props.getArticles} />
        {this.props.articles.map(v => (
          <Article key={v.id} article={v} />
        ))}
      </div>
    );
  }
    ...
    return (
      <div className="ArticleInput">
        ...
        <div className="ArticleInput__content">
          ...
          <input
            id="content"
            className="ArticleInput__question"
            type="text"
            placeholder="장동혁님, 무슨생각을 하고 계신가요?"
        ...
        <div className="AriticleInput__footer">
          <div className="ArticleInput__footer__menu">
            <FontAwesomeIcon icon="image" /> 사진/동영상
          </div>
          <div className="ArticleInput__footer__menu">
            <FontAwesomeIcon icon="user" /> 친구 태그하기
          </div>
          <div className="ArticleInput__footer__menu">
            <FontAwesomeIcon icon="smile-wink" /> 기분/활동
          </div>
          <div className="ArticleInput__footer__menu">
        ...
        <div className="ArticleInput__button">
          <button id="write-btn" type="button" onClick={this.writingHandler}>
            공유하기
          </button>
        </div>
      </div>
...
function Article({ article }) {
  return (
    <div className="Article">
      <div className="Article__header">
        ...
        <div className="Article__header__title">
          <div className="Article__header__title__text">
            {article.user_id + " "}
            {article.group_name ? (
              <FontAwesomeIcon className="NavIcon__svg" icon="caret-right" />
            ) : (
              ""
            )}
      ...
      <div className="Article__footer">
        <div className="Article__footer__menu">
          <FontAwesomeIcon icon={["far", "thumbs-up"]} /> 좋아요
        </div>
        <div className="Article__footer__menu">
          <FontAwesomeIcon icon={["far", "comment-alt"]} /> 댓글
        </div>
        <div className="Article__footer__menu">
          <FontAwesomeIcon icon={["fas", "reply"]} flip="horizontal" /> 공유하기
        </div>
      </div>
    </div>
  );
  function timeParser(time) {
    ...
    let timeString = "";
    if (
      (time.getYear() + time.getMonth() + time.getDate()).toString() !==
